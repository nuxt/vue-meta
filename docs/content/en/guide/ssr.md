...
Notice the use of `{{{` to avoid double escaping. Be extremely cautious when you use `{{{` with [`__dangerouslyDisableSanitizersByTagID`](/api/metainfo-properties#__dangerouslydisablesanitizersbytagid).
