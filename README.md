> :ribbon: The first release candidate for v2.0 has been [released](https://github.com/nuxt/vue-meta/releases). Click [here](https://github.com/nuxt/vue-meta/tree/1.x) if you are looking for the old v1 readme
